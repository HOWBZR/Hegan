    ...
    return (
        <div data-aos={props.fade} className=" md:w-1/3  p-10 sticky top-0">
            ...
            <div className="text-gray-700  text-center bg-gray-400 p-2 shadow-lg rounded shadow-lg">
                    ...
                    <p>{props.text}</p>
                <button className="bg-blue-600 px-2 rounded mt-2 shadow-lg text-white  transform hover:-translate-y-1 hover:scale-110 transition duration-500 ease-in-out"><a href={props.link} target="_blank">Check it out</a></button>
                </div>
                  </div>            
              </div>
    )
